...
const myWork = [
  {
    ...
    'addtext':"Selection of textures and images from the installation:",
    'gallery': {
      'gallerysrc':[
        {
  ...
  },
  {
    ...
    'addtext':"From design to the real world",
    'gallery': {
      'gallerysrc': [
        {
  ...
  },
  {
    ...
    'addtext':"Some early sketches of environment and enemy concepts that were later modeled and used in the actual game.",
    'gallery': {
      'gallerysrc': [
        {
        ...
        },
        {
          ...
          'tooltip': "Concept design for environment"
        },
        {
  ...
  },
  {
    ...
    'addtext':"Random selection of things that I have done for fun:",
    'gallery': {
      'gallerysrc': [
        {
